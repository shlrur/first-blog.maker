...
Jekyll은 github에서 **공짜**로 **posting**해주는 **static website** generator입니다. 예, website를 직접 제작해야 합니다.
...
그런데 아무리 찾아봐도 menu가 hierarchy 구조로 구성된 테마는 찾을 수 없었습니다. 모든 테마를 본 건 아니지만, 페이지를 아무리 넘겨도 그런 구조는 찾을 수가 없었습니다(ㅠ...)
